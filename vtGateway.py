...
class BacktestingAccountData(VtAccountData):
    """回测账户数据类"""
    
    #----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(BacktestingAccountData, self).__init__()
        
        self.startup = 1000000.0
        self.securities = {} # {'IF0000":(2423,30)}
        self.balanceLog = {}
    
    def updateBalanceLog(self):
        
        dt = datetime.now()
        self.balanceLog[dt] = self.balance
